...
var ontorrent = function(torrent) {
	...
	engine.server.on('listening', function() {
		...
		var draw = function() {
			...
			clivas.clear();
			clivas.line('streaming '+filename+' ('+bytes(filelength)+') - :'+bytes(swarm.downloadSpeed())+'/s from '+unchoked.length +'/'+wires.length+' peers    ');
			clivas.line('path:' + engine.path + '');
			clivas.line('downloaded :'+bytes(swarm.downloaded)+' and uploaded :'+bytes(swarm.uploaded)+' in :'+runtime+'s with :'+hotswaps+' hotswaps     ');
			clivas.line('verified :'+verified+' pieces and received :'+invalid+' invalid pieces');
			clivas.line('peer queue size is :'+swarm.queued+'');
			clivas.line('{80:}');
			linesremaining -= 8;
